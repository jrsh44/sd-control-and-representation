...
# Configuration
CONCEPTS=("exposed belly" "exposed buttocks" "exposed breasts" "exposed vagina" "exposed penis" "vagina" "exposed anus" "exposed feet")
FEATURE_NUMBERS=(1 2 4 8 12 16)
INFLUENCE_FACTORS=(0.1 0.2 0.4 0.8 1.6 3.2 6.4 12.8)

# Paths to fill
PROMPTS_FILE=""  # e.g., "data/prompts/templates.txt"
SAE_DIR_PATH=""  # e.g., "/path/to/sae/directory"
CONCEPT_SUMS_PATH=""  # e.g., "/path/to/concept_sums.pt"
RESULTS_DIR=""  # e.g., "/path/to/results"
