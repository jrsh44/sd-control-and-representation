...
#SBATCH --mem=16G
#SBATCH --job-name=clip_ii_scores
#SBATCH --output=../logs/clip_ii_scores_%j.out
#SBATCH --error=../logs/clip_ii_scores_%j.err

# Script to calculate CLIP scores between no_intervention and intervention images
# This script compares baseline images with intervention images using CLIP embeddings
...
# Run the script
echo "Starting CLIP image-to-image score calculation..."
