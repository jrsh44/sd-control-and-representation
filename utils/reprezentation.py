...
class LayerPath(Enum):
    ...
    UNET_UP_2_ATT_0 = "unet.up_blocks.2.attentions.0.transformer_blocks.0"  # Early boundary alignment
    ...
    UNET_UP_1_ATT_0 = "unet.up_blocks.1.attentions.0.transformer_blocks.0"  # Coarse detail alignment
