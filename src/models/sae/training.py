...
def train_sae_val(
    ...
    for epoch in range(nb_epochs):
            ...
            if monitoring:
                ...
                if batch_idx % log_interval == 0:
                    ...
                    with torch.no_grad():
                        ...
                        # Fraction of this batch where feature is active > 0.01
                        ...
                        if wandb_enabled and WANDB_AVAILABLE:
                            ...
                            if dead_tracker is not None:
                                step_log["train/dead_features_ratio"] = (
                                    dead_tracker.get_dead_ratio()
                                )
        ...
        # Note: We now log per batch, so these are just for the print summary
